...
<body>
    ...
    <section class="booking">
        <h1 class="heading-title">apa destinasi favoritmu?</h1>
        <form action="favorite_form.php" method="post" class="book-form">
            <div class="flex">
                <div class="inputBox">
                    <span>name :</span>
                ...
                <div class="inputBox">
                    <span>favorit :</span>
                    <input type="textarea" placeholder="mana lokasi kesukaanmu !?!" name="favorite">
                </div>
            </div>
