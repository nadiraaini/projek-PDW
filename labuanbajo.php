...
<body>
    <section class="header">
        <a href="home.php" class="logo">Jalan Yuk?</a>
        <nav class="navbar">
    ...
    <section class="home-about">
        <div class="image">
            <img src="images/labuanbajo.jpg" alt="">
        </div>

        <div class="content">
            <h3>Trip to Labuan Bajo 5D4N</h3>
            <p>•Hari 1:</p>
            <p>Ende + Moni (Hotel)</p>
            <p>•Hari 2:</p>
            <p>Moni + Danau Kelimutu + Bajawa (Hotel)</p>
            <p>•Hari 3:</p>
            <p>Hotel + Desa Adat Bena + Ruteng (Lodok cara) + Labuan bajo (Hotel)</p>
            <p>•Hari 4:</p>
            <p>Labuan Bajo + Padar +Pink Beach + Komodo + Kanawa island + Hotel</p>
            <p>•Hari 5:</p>
            <p>Hotel + Airport</p>
            <a href="package.php" class="btn">back to package</a>
        </div>
    </section>
